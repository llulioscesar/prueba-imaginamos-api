...
export class ClienteController {
    ...
    @ApiInternalServerErrorResponse({description: 'Ocurrio un error al crear el cliente', type: MensajeError})
    ...
    @ApiInternalServerErrorResponse({description: 'Ocurrio un error al actualizar el cliente', type: MensajeError})
    ...
    @ApiInternalServerErrorResponse({description: 'Ocurrio un error al consultar el cliente por correo', type: MensajeError})
